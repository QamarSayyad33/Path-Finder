...
import './Calender.css'; // Ensure CSS is imported

function BlankPage() {
    // Set default month and year to today's date
    ...
    const contestsByDay = contests.reduce((acc, contest) => {
        ...
        if (contestDate.getMonth() === month && contestDate.getFullYear() === year) {
    ...
    return (
        <div className="calendar">
            <h2>Programming Contests Calendar</h2>
